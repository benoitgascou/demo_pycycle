...
if select_page == page1:
	...
	"</ul></p><br>"
	"<p style = 'font-size: 19px'>Facteurs exceptionnels : boom du trafic dû aux grèves et à la pandémie, chute mitigée selon les confinements"
	"<ul>"
	...
	"Depuis, nous notons une hausse supplémentaire de <strong>23 %</strong>. "
	...
	"<ul>"
	  ...
	  "<li><strong>Entraînement</strong> du 1er au 23 de chaque mois et test à partir du 24</li>"
	  "<li><strong>Performance +++</strong> : "
	  "<span style='color: #1ca2d1; font-weight: bold'>R² train/test : 0.92 / 0.91 - RMSE train/test : 34.2 / 33.7</span></li>"
	  "<li><strong>Représentation graphique</strong> : </li>"
	"</ul>"
	"</p>"
	, unsafe_allow_html=True)
	...
	"<ul>"
	  ...
	  "<li><strong>Choix du modèle</strong> : LinearRegression, le plus robuste parmi les 8 modèles de régression testés.</li>"
	  "<li><strong>Entraînement</strong> sur 12 mois (oct 2019 - sep 2020) et <strong>test</strong> sur 4 mois (sept - déc 2020)</li>"
	  "<li><strong>Performance ++</strong> : "
	...
	st.markdown(
	"<p style = 'font-size: 19px'>Conclusion</p>"
	"<p style='text-align: justify'>"
	"<ul>"
